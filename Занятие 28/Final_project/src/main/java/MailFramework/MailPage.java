...
public class MailPage {
	...
	@FindBy(xpath = "//a [@ rel=\"history\"] //span[@ class=\"b-datalist__item__status-unread\"]")
	...
	public void enterToAccount(String log, String pass) { // not correct or correct
		login.sendKeys(log);
	...
	public void whatWait(WebElement element) {
		wait = new WebDriverWait(mail, 10000);
